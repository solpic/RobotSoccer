...
c.set(cv.CV_CAP_PROP_FRAME_WIDTH, 1280)
c.set(cv.CV_CAP_PROP_FRAME_HEIGHT, 720)
...
while(1):
    ...
    erode_corners = cv2.erode(corners,None,iterations = 1)
    dilate_corners = cv2.dilate(erode_corners,None,iterations = 3)
    ...
    erode_ball = cv2.erode(ball_img,None,iterations = 1)
    dilate_ball = cv2.dilate(erode_ball,None,iterations = 3)
